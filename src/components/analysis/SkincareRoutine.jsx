                    ...
                    <div className="p-6 md:p-8 flex flex-col md:flex-row items-center gap-8">
                        ...
                        <div className="flex-1 text-center md:text-left w-full">
                            ...
                            <div className="flex flex-col sm:flex-row gap-3 justify-center md:justify-start">
                                <button onClick={(event) => window.emailService?.promptSendEmail?.()} className="px-5 py-2.5 bg-rose-600 hover:bg-rose-700 text-white rounded-xl font-bold text-xs sm:text-sm shadow-md hover:-translate-y-0.5 transition-all flex items-center justify-center gap-2 scan-primary-button">
                                    <i data-feather="mail" className="w-4 h-4"></i> Gửi báo cáo về Email
                                </button>
                                <button onClick={() => { window.location.href = '/profile?tab=history'; }} className="px-5 py-2.5 bg-brand-primary text-white rounded-xl font-semibold text-xs sm:text-sm shadow-md shadow-brand-primary/20 hover:-translate-y-0.5 transition-all flex items-center justify-center gap-2 scan-primary-button">
            ...
            <button className="bg-brand-dark text-white px-5 py-2.5 rounded-xl text-sm font-bold shadow-md hover:-translate-y-0.5 transition-transform flex items-center justify-center gap-2 scan-primary-button">
                Xem chi tiết liệu trình <i data-feather="arrow-right" className="w-4 h-4"></i>
                    ...
                    <div className="mt-6 text-center">
                        <button className="btn-hover-effect w-full md:w-auto bg-brand-primary text-white px-8 py-4 rounded-xl font-bold text-lg inline-flex items-center justify-center gap-2 shadow-lg shadow-brand-primary/30 scan-primary-button" onClick={(event) => window?.addAllToCart?.()}>
                ...
                <div className="bg-gradient-to-r from-gray-900 to-brand-dark rounded-2xl p-6 text-white text-center md:text-left flex flex-col md:flex-row items-center justify-between gap-6">
                    ...
                    <div className="w-full md:w-auto flex flex-col sm:flex-row gap-2">
                        ...
                        <button className="px-5 py-2.5 bg-brand-primary text-white rounded-xl font-semibold hover:bg-brand-accent transition-colors flex-shrink-0 scan-primary-button">
                            Nhắc tôi
                        </button>
                    </div>
                </div>

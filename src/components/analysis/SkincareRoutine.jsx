            ...
            <div id="analyzing-flow" className="hidden flex-grow flex flex-col items-center justify-center py-10 px-4">
                ...
                <div id="analysis-error-card" className="hidden w-full max-w-sm mt-6 p-4 rounded-2xl bg-rose-50/90 border border-rose-200 text-center shadow-sm">
                    ...
                    <div className="flex gap-2 justify-center">
                        <button id="analysis-retry-btn" type="button" className="px-4 py-2 bg-[#1E1B1D] text-white text-xs font-bold rounded-xl shadow hover:bg-black transition-all flex items-center gap-1.5 cursor-pointer">
                    ...
                    <div className="p-6 md:p-8 flex flex-col md:flex-row items-center gap-8">
                        ...
                        <div className="flex-1 text-center md:text-left w-full">
                            ...
                            <div className="flex flex-col sm:flex-row gap-3 justify-center md:justify-start">
                                <button onClick={(event) => window.emailService?.promptSendEmail?.()} className="px-5 py-2.5 bg-[#1E1B1D] hover:bg-black text-white rounded-xl font-bold text-xs sm:text-sm shadow-sm hover:-translate-y-0.5 transition-all flex items-center justify-center gap-2 scan-primary-button">
            ...
            <button className="bg-brand-dark text-white px-5 py-2.5 rounded-xl text-sm font-bold shadow-md hover:-translate-y-0.5 transition-transform flex items-center justify-center gap-2 scan-primary-button">
                Xem chi tiết liệu trình <i data-feather="arrow-right" className="w-4 h-4"></i>
                    ...
                    <div className="mt-6 text-center">
                        <button className="btn-hover-effect w-full md:w-auto bg-[#1E1B1D] hover:bg-black text-white px-8 py-3.5 rounded-xl font-bold text-base inline-flex items-center justify-center gap-2 shadow-md hover:shadow-lg transition-all scan-primary-button cursor-pointer" onClick={(event) => window?.addAllToCart?.()}>
                ...
                <div className="bg-gradient-to-r from-gray-900 to-brand-dark rounded-2xl p-6 text-white text-center md:text-left flex flex-col md:flex-row items-center justify-between gap-6">
                    ...
                    <div className="w-full md:w-auto flex flex-col sm:flex-row gap-2">
                        ...
                        <button className="px-5 py-2.5 bg-[#1E1B1D] hover:bg-black text-white rounded-xl font-bold transition-all flex-shrink-0 scan-primary-button cursor-pointer">
                            Nhắc tôi
                        </button>
                    </div>
                </div>

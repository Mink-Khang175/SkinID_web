  ...
  return (
    <section id="brand-bar" className="brand-tabs" aria-label="Thương hiệu đồng hành">
      <div className="container brand-tabs-grid">
        <button className="brand-tab is-active" type="button" data-brand-tab="RILASTIL" data-active-slide="0" aria-pressed="true">
          <strong className="brand-tab-wordmark">RILASTIL</strong>
          <span><b>Dược mỹ phẩm từ Ý</b><small>46 sản phẩm</small></span>
        </button>
        <button className="brand-tab brand-tab--ai" type="button" data-brand-tab="AI" data-active-slide="1" aria-pressed="false">

        ...
        <div id="product-detail-modal-content" className="scale-95 opacity-0">
          <div className="pmodal-scroll">
            ...
            <div className="spec">
              ...
              {/* Official First Page of TEMPLATE FOR NOTIFICATION OF COSMETIC PRODUCT - On-Demand Accordion */}
              <div id="pmodal-license-container" className="mt-4 hidden">
                <button
                  id="pmodal-license-toggle"
                  type="button"
                  className="w-full flex items-center justify-between p-3 rounded-xl border border-rose-200/80 bg-rose-50/40 hover:bg-rose-50/90 transition-all text-left group cursor-pointer"
                  onClick={() => window.toggleLicensePreview?.()}
                  title="Nhấn để xem Phiếu công bố sản phẩm mỹ phẩm"
                >
                  <div className="flex items-center gap-2.5 min-w-0">
                    <div className="w-8 h-8 rounded-lg bg-white shadow-2xs border border-rose-200/80 flex items-center justify-center flex-shrink-0 text-rose-600 group-hover:scale-105 transition-transform">
                    ...
                    <div className="min-w-0">
                      <div className="flex items-center gap-1.5 flex-wrap">
                        <span className="text-xs font-bold text-gray-900 tracking-tight uppercase group-hover:text-rose-700 transition-colors">
                      ...
                      <p className="text-[11px] text-gray-500 truncate mt-0.5">
                        Phiếu tiếp nhận công bố mỹ phẩm chính ngạch • Nhấn để xem văn bản
                      </p>
                    </div>
                  </div>
                  <div className="flex items-center gap-1 text-xs font-semibold text-rose-600 flex-shrink-0 ml-2">
                    <span id="pmodal-license-toggle-text">Xem phiếu</span>
                    <svg id="pmodal-license-arrow" className="w-4 h-4 transition-transform duration-200" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                      <polyline points="6 9 12 15 18 9"></polyline>
                    </svg>
                  </div>
                </button>

                {/* Expandable Document Drawer: Hidden until clicked */}
                <div id="pmodal-license-drawer" className="hidden mt-2 pt-1 transition-all duration-300">
                  <div className="pmodal-license-preview relative rounded-xl border border-gray-200/90 bg-gray-50/70 p-2 shadow-2xs group cursor-zoom-in overflow-hidden transition-all hover:border-gray-400" onClick={() => window.openLicenseModal?.()} title="Bấm để phóng to xem rõ nét trang 1">
                    <div className="flex items-center justify-between px-1 mb-2">
                      <span className="text-[11px] font-medium text-gray-500">Trang 1 • Phiếu tiếp nhận chính thức</span>
